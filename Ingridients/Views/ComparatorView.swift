...
struct ComparatorView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .progress(isOn: ingridientsA.isThinking || ingridientsB.isThinking)
        }
    }
}
